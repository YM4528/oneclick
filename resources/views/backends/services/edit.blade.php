...
<div class="container bg-dark p-5">
  <h2 class="pl-5"><i class="fa-solid fa-pen-to-square"></i> Edit Service</h2>
  ...
  <form class="p-5" action="{{route('services.update', $services->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">

      <label for="title">Title</label>
      <input name="title" type="text" class="form-control" id="title" value="{{$services->title}}">
    </div>
